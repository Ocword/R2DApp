...
void controlEvent(ControlEvent theEvent) {
  ...
  if (theEvent.isFrom(guardar)) {
    ...
    saltaData = cp5LD.get(Textfield.class, "rioNegroData").getText();
    ...
    output.print(newNameData + ",");
    
    output.print(buenosAiresData + ",");
    output.print(catamarcaData + ",");
    output.print(chacoData + ",");
    output.print(chubutData + ",");
    output.print(CABA + ",");
    output.print(cordobaData + ",");
    output.print(corrientesData + ",");
    output.print(entreRiosData + ",");
    output.print(formosaData + ",");
    output.print(jujuyData + ",");
    output.print(laPampaData + ",");
    output.print(laRiojaData + ",");
    output.print(mendozasData + ",");
    output.print(misionesData + ",");
    output.print(neuquenData + ",");
    output.print(rioNegroData + ",");
    output.print(saltaData + ",");
    output.print(sanJuanData + ",");
    output.print(sanLuisData + ",");
    output.print(santaCruzData + ",");
    output.print(santaFeData + ",");
    output.print(sgoDelEsteroData + ",");
    output.print(tierraDelFuegoData + ",");
    output.println(tucumanData + ",");
    output.close();
